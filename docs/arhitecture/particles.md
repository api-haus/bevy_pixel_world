...
Free-form particle system for dynamic effects that complement the cellular automata simulation.
...
- **Explosion debris** - dust, rubble, fragments ejected by blasts
...
- Fixed-size particle pool (configurable, e.g., 10,000 particles)
- When pool is full, oldest particles are removed or new emissions are skipped
