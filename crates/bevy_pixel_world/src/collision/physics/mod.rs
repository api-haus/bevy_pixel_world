...
//!
//! Provides optional feature-gated support for avian2d and rapier2d physics
//! engines. Enable one (but not both) via Cargo features:
//!
//! ```toml
...
use crate::coords::{TILE_SIZE, TilePos};
