...
//!
//! Run: cargo test -p bevy_pixel_world --features rapier2d body_rapier2d_e2e
...
impl TestHarness {
  ...
  fn spawn_pixel_body(
    ...
    let collider =
      bevy_pixel_world::generate_collider(&body).expect("body should produce a valid collider");
    ...
    self
      ...
      .spawn((
        ...
        bevy_pixel_world::CollisionQueryPoint,
        bevy_pixel_world::StreamCulled,
      ))
      .id()
  }
