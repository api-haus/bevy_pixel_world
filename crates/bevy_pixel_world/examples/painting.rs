...
use bevy_pixel_world::visual_debug::{
    visual_debug_checkboxes, SettingsPersistence, VisualDebugSettings,
};
use bevy_pixel_world::{
    collision::CollisionQueryPoint, material_ids, ColorIndex, MaterialId, MaterialSeeder,
    Materials, Pixel, PixelWorld, PixelWorldPlugin, SpawnPixelWorld, StreamingCamera, WorldRect,
};
            ...
            egui::CollapsingHeader::new("Brush")
                ...
                .show(ui, |ui| {
                    ...
                    for id in [
                        ...
                        if ui.selectable_label(brush.material == id, mat.name).clicked() {
                            brush.material = id;
                        }
                    }
                    ...
                    ui.add(
                        egui::Slider::new(&mut radius, MIN_RADIUS as f32..=MAX_RADIUS as f32)
                            .text("Size"),
                    );
