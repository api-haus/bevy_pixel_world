        ...
        for ly in 0..CHUNK_SIZE {
            for lx in 0..CHUNK_SIZE {
                ...
                chunk.pixels.set(
                    lx,
                    ly,
                    Pixel::new(material_ids::STONE, ColorIndex(gray)),
                );
            }
        }
    }
...
impl MaterialSeeder {
    ...
    ///
    /// - `seed`: Deterministic seed for noise generation.
    /// - `feature_scale`: Controls primary feature size (larger = larger features).
        ...
        for ly in 0..CHUNK_SIZE {
            for lx in 0..CHUNK_SIZE {
                ...
                if dist == 0 {
                    ...
                    chunk.pixels.set(lx, ly, Pixel::new(material, ColorIndex(color)));
                }
            }
        }
    }
