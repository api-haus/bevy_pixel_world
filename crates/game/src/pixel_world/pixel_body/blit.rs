...
use crate::pixel_world::coords::{WorldPos, WorldRect};
...
use crate::pixel_world::material::{Materials, PhysicsState, ids as material_ids};
...
pub(super) fn clear_body_pixels(
  ...
  let void = Pixel::new(
    material_ids::VOID,
    crate::pixel_world::coords::ColorIndex(0),
  );
