...
pub struct ChunkSlot {
  ...
  pub pos: Option<crate::pixel_world::coords::ChunkPos>,
...
impl ChunkSlot {
  ...
  pub(crate) fn initialize(&mut self, pos: crate::pixel_world::coords::ChunkPos) {
    self.lifecycle = ChunkLifecycle::Seeding;
    self.pos = Some(pos);
  ...
  pub(crate) fn initialize_loading(&mut self, pos: crate::pixel_world::coords::ChunkPos) {
    self.lifecycle = ChunkLifecycle::Loading;
    self.pos = Some(pos);
    self.chunk.set_pos(pos);
    self.dirty = false;
