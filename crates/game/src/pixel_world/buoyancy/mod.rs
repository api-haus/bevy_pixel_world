...
//!   from [`LiquidFractionState`](crate::pixel_world::pixel_awareness::LiquidFractionState),
...
//!
//! ```ignore
//! use crate::pixel_world::buoyancy::{Buoyancy2dPlugin, BuoyancyConfig};
//!
...
//! # Requirements
//!
//! This module requires the `physics` cfg flag to be enabled (set by build.rs).
...
///
/// Requires [`PixelAwarenessPlugin`](crate::pixel_world::pixel_awareness::PixelAwarenessPlugin)
/// to be added first.
///
/// # Configuration
///
