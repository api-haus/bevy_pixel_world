...
mod test {
  ...
  fn test_complex_example() {
    let example = "\0\0\u{1b}[2m2025-01-03T16:58:02.690280Z\u{1b}[0m \u{1b}[31mERROR\u{1b}[0m \
                   error: Could not find function: Displaying ScriptValue without world access: \
                   String(";
